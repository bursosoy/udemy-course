...
<div class="cmn_card contact-card" @mouseover="hovered(true)" @mouseout="hovered(false)" @click="cardClicked(person)">
    <div class="contact">
        <div class="avatar" :style="this.person.iconURL"></div>
        <div class="info">
            <div class="name" :title="this.person.name"><b>{{ this.person.name }}</b></div>
