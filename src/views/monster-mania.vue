...
<div style="display:flex; flex-direction: column">
    ...
    <div class="monster-mania-main">
        <div v-for="team in teams" :key="team" class="team">
            <div @click="currentTurn == monster.team ? monsterHit(monster) : ''" v-for="monster in team.roster" :key="monster" :class="class_monsterStatus(monster)" class="monster-card cmn_card"
            :style="style_monsterHealthBar(monster)">
                ...
                <div class="monster-info">
                    ...
                    <div class="monster-life"><b>{{ monster.damage }}</b>&nbsp;
...
export default {
    ...
    computed: {
        monsterNames() {
            ...
            attackLogLength(){ // watch object property
    ...
    methods: {
        generateTeam(team) {
            ...
            monsterHit(monster) {
                ...
                // logging the action
                const log = `<b>(${this.teamName[0]}) ${monster.name}</b> -- attacks -- <b> (${this.teamName[1]}) ${attackedTeam[attackedMonsterIndex].name}</b> for ${monster.damage + monster.specialAttack.value}`
